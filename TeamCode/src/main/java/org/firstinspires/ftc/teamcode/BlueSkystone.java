            ...
            public void runOpMode() {
             ...
             //   telemetry.update();
                ...
                if (skystonePosition == 2) {
                    skystonePosition2 = 23;
                    Robot.strafeLeft(0.55, "");
                    Robot.goBack(0.3, "end jump");
                    Robot.centerRobotLeft(skystonePosition2, 0.6, 0.04);
                    Robot.moveIn();
                    Robot.goBack(0.02, "");
                ...
                if (skystonePosition == 3) {
                    skystonePosition2 = 15;
                    Robot.strafeLeft(0.95, "");
                    Robot.goBack(0.3, "end jump");
                    Robot.centerRobotLeft(skystonePosition2, 0.6, 0.04);
                    Robot.moveIn();
                    Robot.goBack(0.02, "");
                ...
                Robot.goForward(0.33, "");
                Robot.turnLeft(0.8, "");
                Robot.alignRight();

                Robot.centerRobotRight(24, 2, 0.08);
                Robot.goBack(((48 - skystonePosition2)/50 + 1.1), "");
     ...
     /*           if (skystonePosition == 2) {
               ...
               //     Robot.strafeRight (0.4, "");
                //    Robot.goForward(0.9, "");
                    ...
                    Robot.centerRobotForward(41.5, 1, 0.03);
                    Robot.strafeRight(0.3, "");
                    Robot.setForwardSpeed(1.0);

                    Robot.strafeLeft(2.5, "");
