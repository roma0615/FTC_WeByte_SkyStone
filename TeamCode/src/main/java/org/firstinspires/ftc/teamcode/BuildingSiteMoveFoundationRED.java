...
@Autonomous(name="BuildingSiteMoveFoundationRED")
...
public class BuildingSiteMoveFoundationRED extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Step 0: strafe right
        Robot.strafeRight(0.7, "Strafe right");
        ...
        Robot.turnRight(2.2, "Turning left");

        // Step 4:  Strafe left for 1.2 Second
        Robot.setServos(FlipperPosition.SIDE, 0, "Lifting servos");
        ...
        // Step 5: turn left
        Robot.turnLeft(1.1, "Turning right");
